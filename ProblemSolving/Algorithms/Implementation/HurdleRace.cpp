...
For example, if height={1,2,3,3,2} and Dan can jump 1 unit high naturally, he must take 3-1=2 doses
of potion to be able to jump all of the hurdles.

Function Description
Complete the hurdleRace function to return the minimum units of potion Dan needs to drink to jump
all of the hurdles.
...
Constraints: 1 <= n, k, height[i] <= 100

Output Format : Print an integer denoting the minimum doses of magic potion Dan must drink to
