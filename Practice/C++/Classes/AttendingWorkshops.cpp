//============================================================================
// Name        : AttendingWorkshops.cpp
// Author      : Robert Buzabrici-Filipescu
// Copyright   : HackerRank
// Link        : https://www.hackerrank.com/challenges/attending-workshops/problem
//============================================================================
/* Description :
...
Here, start_time[] and duration[] are the respective start time and duration for the  workshop.
...
Constraints : 1 <= N <= 10^5; 0 <= start_time[i] <= 1000; 0 <= duration[i] <= 1000
*/
