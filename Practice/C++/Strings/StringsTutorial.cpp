...
Input Format : You are given two strings, a and b, separated by a new line. Each string will consist of lower case Latin 
characters ('a'-'z').
...
In the third line print two strings separated by a space, a1 and b1. a1 and b1 are the same as a and b, respectively, except that 
