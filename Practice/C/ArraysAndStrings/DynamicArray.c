...
3 x : Print the number of books on the xth shelf.Bookshelves
Snow Howler has got an assistant, Oshie, provided by the Department of Education.
Although inexperienced, Oshie can handle all of the queries of types 2 and 3.
Help Snow Howler deal with all the queries of type 1.
Oshie has used two arrays:
int* total_number_of_books; * This stores the total number of books on each shelf.
int** total_number_of_pages; * This stores the total number of pages in each book of each shelf.
...
Output Format: Write the logic for the requests of type 1. The logic for requests of types 2 and 3 are provided.
*/
