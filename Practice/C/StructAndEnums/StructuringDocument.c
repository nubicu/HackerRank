...
k: This corresponds to calling the function kth_paragraph.
k m: This corresponds to calling the function kth_sentence_in_mth_parapgraph.
k m n: This corresponds to calling the function kth_word_in_mth_sentence_of_nth_paragraph.

Constraints:
The text which is passed to get_document has words separated by a spaces(” “),
...
Output Format: Print the paragraph, sentence or the word corresponding to the query to check the logic of your code.
*/
