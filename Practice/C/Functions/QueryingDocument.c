...
char**** get_document(char* text)
{
    ...
    while (paragraphs[i] != NULL)
    {
        ...
        {
            // remember that doc[0][0] means: paragraph #0, sentence #0 and should
            // act like a pointer to the first element of an array of words (strings)

            // split string by ' ' and associate doc[i][j] with the array of
            // strings representing words that is returned by split_string
